  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb">
        ...
        <li><a href="leads_wind_business.php">Leads</a></li>
            ...
            <div class="tab-pane active" id="tab_1">
			  ...
			  <span class="col-sm-6"> <label>Brand Provenienza</label>
					...
					<span class="col-sm-6"> <label>Esito OP</label>
				  	...
				  	<span class="col-sm-6"> <label>Offerta Nuovo Contratto</label>
						<select id="nuovo_offerta" class="form-control">
							...
							<?php  
								$queryOfferta = "SELECT DISTINCT(id_off), offerta FROM offerte_wind_business ";
				  	...
				  	<span class="col-sm-6"> <label>Prezzo Nuovo Contratto</label>
						...
						<option value="0" <?php if($do['prezzo']==" ") echo "selected" ?>>---</option>
							<?php  
								$queryPrezzo = "SELECT DISTINCT(id_off), offerta, prezzo FROM offerte_wind_business ";
                    ...
                    <div class="box-footer clearfix">
                        <buttone onclick="modifica_leads_wind_business()" class="btn btn-sm btn-primary btn-flat pull-left">Modifica</buttone>
                    </div>
