...
#myModal {
    ...
    max-height: 200px; /* Imposta l'altezza massima del popup */
...
<div class="content-wrapper">
    <section class="content">
        <section class="content-header">
            <? $query_ragione_sociale="SELECT * from ragione_sociale where rag_id=4 ";
      ...
      <div class="row">
          <div class="col-sm-12">
              ...
              <div class="box">
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											...
											<div class="modal-body">
											   ...
											   <div class="col-sm-6"><label >BRAND*</label>
                                                  <select id="nuovo_brand" class="form-control">
                                                    <option value="TIM BUSINESS">TIM BUSINESS</option>
                                                   </select>
                                               </div>
												<div class="col-sm-6">
											...
											<div class="modal-footer">  
                                               <a href="#" class="btn btn-sm btn-primary pull-left" onclick="nuovo_leads_tim_business()">Inserisci</a>
											</div>
										</div>
										<!-- /.modal-content -->
									</div><!-- /.modal-dialog -->
                      ...
                      <thead><tr><th>Data Ins</th><th>Nome</th><th>Email</th><th>Telefono</th><th>Orario</th><th>Provenienza</th><th>Operatore</th><th>Esito OP</th><th>Esito BO</th><th>Note</th><th>Modifica</th></tr></thead>
                        <tbody>
                            <?php 
                           
							$queryLeads="SELECT * FROM leads WHERE brand LIKE 'TIM BUSINESS' order by data_inserimento DESC"; 
                            ...
                            <td><?php echo $data_inserimento; ?>
								...
								<td>
									<?php 
                                          ...
                                          if($row['esito_op']==9)
											 echo "GIA' CLIENTE TIM CONSUMER";
                                          if($row['esito_op']==12)
											 echo "GIA' CLIENTE TIM BUSINESS"; 
                                          if($row['esito_op']==10)
								...
								<td>
									<?php 
                                       ...
                                       if($row['esito_bo']==7)
                                          echo "ATTIVO";
                                       if($row['esito_bo']==8)
                                          echo "<p style='background-color:red; padding: 5px; color: white;'>KO</p>";
                                       if($row['esito_bo']==9)
                                          echo "IN GESTIONE";
                                       if($row['esito_bo']==10)
                                          echo "SCARTATO";
                                ...
                                <td>
                                   <div class="btn-group">
                                        <a href="#" role="button" class="btn btn-sm btn-warning" onclick="open_leads_tim_business(<?php echo $id;?>)"><i class="fa fa-pencil" title="Modifica"></i></a>
                         ...
                         <tfoot><tr><th>Data Ins</th><th>Nome</th><th>Email</th><th>Telefono</th><th>Orario</th><th>Provenienza</th><th>Operatore</th><th>Esito OP</th><th>Esito BO</th><th>Note</th><th></th></tr></tfoot>
...
$(document).ready(function() {
    ...
    function checkNewLeads() {
        $.ajax({
            url: 'check_new_leads_tim_business.php', // URL del file PHP per controllare le nuove lead
            type: 'GET',
            dataType: 'json',
    ...
    // Controlla le nuove lead ogni 1 minuti (60.000 millisecondi)
    setInterval(checkNewLeads, 600000); // Cambia 60000 con il tempo desiderato in millisecondi
