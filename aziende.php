...
if($user!=""){
    $queryUtenti="Select * from ragione_sociale";
          ...
          <div class="col-sm-12">
              ...
              <div class="box">
										...
										<div class="modal-content">
											...
											<div class="modal-body">
                                                                                            <div class="col-sm-6">
                                                                                                ...
                                                                                                <div class="col-sm-6"><label>Colore</label>
                                                                                                <input type="text" id="nuovo_color" class="form-control my-colorpicker1"></div>
                                                                                            
											</div>
                                                                                     
											<div class="modal-footer">  
                                                                                            <a href="#" class="btn btn-sm btn-primary pull-left" onclick="crea_azienda()">Inserisci</a>
                  ...
                  <table id="example" class="table table-bordered table-hover">
                      <thead><tr><th>Descrizione</th><th>Colore</th><th>#</th></tr></thead>
                        <tbody>
                            <?php 
                            ...
                            <tr id="id_<?php echo $id;?>">
                                ...
                                <td><div class="btn  btn-flat margin" style="background: <?php echo $color; ?>"></div>
                                <input type="text" hidden id="color_<?php echo $id;?>" value="<?php echo $color; ?>"></td>
                                ...
                                <td>
                                    ...
                                    <a href="#" role="button" class="btn btn-sm btn-default" onclick="del_azienda(<?php echo $id;?>)"><i class="fa fa-trash" title="Elimina"></i></a></div>
                                <?php }?>
                                </td></tr>
										...
										<div class="modal-content">
											...
											<div class="modal-body">
                                                                                               <div class="col-sm-6">
                                                                                                ...
                                                                                                <div class="col-sm-6"><label>Colore</label>
                                                                                                <input type="text" id="modifica_color" class="form-control my-colorpicker1"></div>
											</div>
                                                                                     
											<div class="modal-footer">  
                                                                                            <input type="text" id="modifica_id" hidden>
                                                                                            <a href="#" class="btn btn-sm btn-primary pull-left" onclick="modifica_azienda()">Modifica</a>
...
function open_modifica(id){
    ...
    $("#modifica_color").attr('value', color);
