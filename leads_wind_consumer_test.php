              ...
              <div class="box">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab">TUTTE LE LEADS</a></li>
                        <li><a href="#tab_2" data-toggle="tab">TRATTATIVE</a></li>
                        <li><a href="#tab_3" data-toggle="tab">DA ESITARE</a></li>
                        </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                  	<table id="example" class="table table-bordered table-hover">
                          <!-- Content Header (Page header) -->
                    <thead><tr><th>Data Ins</th><th>Nome</th><th>Email</th><th>Telefono</th><th>Orario</th><th>Indirizzo IP</th><th>Lotto</th><th>Provenienza</th><th>Esito OP</th><th>Esito BO</th><th>Note</th><th>Modifica</th></tr></thead>
                    <tbody>
                        <?php 
          ...
          <table id="example" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php 
                           ...
                           $queryLeads = "SELECT * FROM leads WHERE brand LIKE 'WIND CONSUMER' AND esito_op = 11 ORDER BY data_inserimento DESC";
          ...
          <table id="example" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php 
                           ...
                           $queryLeads = "SELECT * FROM leads WHERE brand LIKE 'WIND CONSUMER' AND esito_op = 1 AND esito_bo = 0 ORDER BY data_inserimento DESC";
