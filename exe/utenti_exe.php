...
$query=mysqli_fetch_array(mysqli_query($db_connect, "SELECT id_utente, user, password, tipologia, ragione_sociale_utente FROM utenti WHERE user='$nick' AND password='$pass'"));
$arrayReturn = array();
...
if($operazione=="login") {
	...
	if(($query['user']=="$nick") &&($query['password']=="$pass") ){
		...
		$_SESSION['id_utente'] = $query['id_utente'];
		$_SESSION['ragione_sociale_utente'] = $query['ragione_sociale_utente'];

		$user=$_SESSION['user'];
        $tipologia=$_SESSION['tipologia'];
		$id_utente=$_SESSION['id_utente'];
		$ragione_sociale_utente=$_SESSION['ragione_sociale_utente'];
