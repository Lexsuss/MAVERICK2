  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb">
        ...
        <li><a href="leads_tim_business.php">Leads</a></li>
			  ...
			  <span class="col-sm-6"> <label>Brand Provenienza</label>
				  	...
				  	<span class="col-sm-6"> <label>Attuale Tecnologia Cliente</label>
						...
						<select id="nuovo_operatore" class="form-control">
                            ...
                            <option value="31" <?php if($do['operatore']=="31") echo "selected" ?>>ANITA GRECO</option>
							<option value="30" <?php if($do['operatore']=="30") echo "selected" ?>>ELENA IGNOTO</option>
                         </select></span>
					<span class="col-sm-6"> <label>Esito OP</label>
                        ...
                        <option value="0" <?php if($do['esito_op']=="0") echo "selected" ?>>INSERITO</option>
							...
							<option value="9" <?php if($do['esito_op']=="9") echo "selected" ?>>GIA' CLIENTE TIM CONSUMER</option>
                            <option value="12" <?php if($do['esito_op']=="12") echo "selected" ?>>GIA' CLIENTE TIM BUSINESS</option>
				  	...
				  	<span class="col-sm-6"> <label>Offerta Nuovo Contratto</label>
						<select id="nuovo_offerta" class="form-control">
							...
							<?php  
								$queryOfferta = "SELECT DISTINCT(id_off), offerta FROM offerte_tim_business ";
				  	...
				  	<span class="col-sm-6"> <label>Prezzo Nuovo Contratto</label>
						...
						<option value="0" <?php if($do['prezzo']==" ") echo "selected" ?>>---</option>
							<?php  
								$queryPrezzo = "SELECT DISTINCT(id_off), offerta, prezzo FROM offerte_tim_business ";
                    ...
                    <div class="box-footer clearfix">
                        <buttone onclick="modifica_leads_tim_business()" class="btn btn-sm btn-primary btn-flat pull-left">Modifica</buttone>
                    </div>
