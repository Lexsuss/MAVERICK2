...
if($user!=""){
    $queryUtenti="Select * from livello";
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">  
                                                                                            <a href="#" class="btn btn-sm btn-primary pull-left" onclick="crea_liv()">Inserisci</a>
                        ...
                        <tbody>
                            ...
                            <tr id="id_<?php echo $id;?>">
                                ...
                                <td>
                                    ...
                                    <a href="#" role="button" class="btn btn-sm btn-default" onclick="del_liv(<?php echo $id;?>)"><i class="fa fa-trash" title="Elimina"></i></a></div>
                                <?php }?>
                                </td></tr>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">  
                                                                                            ...
                                                                                            <a href="#" class="btn btn-sm btn-primary pull-left" onclick="modifica_liv()">Modifica</a>
