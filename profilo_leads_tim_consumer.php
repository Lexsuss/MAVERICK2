  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb">
        ...
        <li><a href="leads_tim_consumer.php">Leads</a></li>
      ...
      <div class="row">
          <div class="col-sm-12">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab">Anagrafica</a></li>
			  ...
			  <span class="col-sm-6"> <label>Brand Provenienza</label>
				  	...
				  	<span class="col-sm-6"> <label>Attuale Tecnologia Cliente</label>
						<select id="nuovo_tecnologia" class="form-control">
                         ...
                         <span class="col-sm-6"> <label>Url Sito</label><input type="text" id="nuovo_url_sito" class="form-control" value="<?= $do[url_sito] ?>"></span>
						 <span class="col-sm-6"> <label>Note</label><textarea id="nuovo_note" class="form-control"><?= $do[note] ?></textarea><br><br></span>					
						...
						<select id="nuovo_operatore" class="form-control">
							...
							<option value="34" <?php if($do['operatore']=="34") echo "selected" ?>>DORIANA DI MAURO</option>
                            <option value="35" <?php if($do['operatore']=="35") echo "selected" ?>>LOREDANA PUGLISI</option>
                            <option value="36" <?php if($do['operatore']=="36") echo "selected" ?>>STEFANIA NICOTRA</option>
                            <option value="37" <?php if($do['operatore']=="37") echo "selected" ?>>LORENA MILO</option>
					...
					<span class="col-sm-6"> <label>Esito OP</label>
                        ...
                        <option value="0" <?php if($do['esito_op']=="0") echo "selected" ?>>INSERITO</option>
							...
							<option value="12" <?php if($do['esito_op']=="12") echo "selected" ?>>PRATICA IN CORSO</option>
				  	...
				  	<span class="col-sm-6"> <label>Offerta Nuovo Contratto</label>
						<select id="nuovo_offerta" class="form-control">
							...
							<?php  
								$queryOfferta = "SELECT DISTINCT(id_off), offerta FROM offerte_tim_consumer ";
				  	...
				  	<span class="col-sm-6"> <label>Prezzo Nuovo Contratto</label>
						...
						<option value="0" <?php if($do['prezzo']==" ") echo "selected" ?>>---</option>
							<?php  
								$queryPrezzo = "SELECT DISTINCT(id_off), offerta, prezzo FROM offerte_tim_consumer ";
					...
					<span class="col-sm-6"><br><br><br><br><br></span>		 
				  	<span class="col-sm-6"> <label>Esito BO</label>
						<select id="nuovo_esito_bo" class="form-control">
							...
							<option value="11" <?php if($do['esito_bo']=="11") echo "selected" ?>>FIRMATO</option>
							<option value="1" <?php if($do['esito_bo']=="1") echo "selected" ?>>ANNULLATO MANCATA FIRMA</option>
							...
							<option value="4" <?php if($do['esito_bo']=="4") echo "selected" ?>>EMESSO</option>
							...
							<option value="8" <?php if($do['esito_bo']=="8") echo "selected" ?>>KO</option>
							<option value="9" <?php if($do['esito_bo']=="9") echo "selected" ?>>IN GESTIONE</option>
							<option value="10" <?php if($do['esito_bo']=="10") echo "selected" ?>>SCARTATO</option>
                         </select></span>
                    ...
                    <div class="box-footer clearfix">
                        <buttone onclick="modifica_leads_tim_consumer()" class="btn btn-sm btn-primary btn-flat pull-left">Modifica</buttone>
                    </div>
