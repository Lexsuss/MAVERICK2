...
<div class="content-wrapper">
    <section class="content">
        <section class="content-header">
            <? $query_ragione_sociale="SELECT * from ragione_sociale where rag_id=3 ";
        ...
        <div class="row">
          <div class="col-sm-12">
              <!-- <a href="#my-modal" role="button" class="btn btn-sm btn-info" data-toggle="modal"><i class="fa fa-plus"></i> Nuova Leads</a> -->
              <div class="box">
										...
										<div class="modal-content">
											...
											<div class="modal-body">
                                                  ...
                                                  <select id="nuovo_brand" class="form-control">
                                                    <option value="TIM CONSUMER">TIM CONSUMER</option>
                                                   </select>
                                               </div>
												<div class="col-sm-6">
											...
											<div class="modal-footer">  
                                               <a href="#" class="btn btn-sm btn-primary pull-left" onclick="nuovo_leads_tim_consumer()">Inserisci</a>
											</div>
										</div>
										<!-- /.modal-content -->
									</div><!-- /.modal-dialog -->
                      ...
                      <thead><tr><th>Data Ins</th><th>Nome</th><th>Email</th><th>Telefono</th><th>Provenienza</th><th>Operatore</th><th>Esito OP</th><th>Esito BO</th><th>Note</th><th>Modifica</th></tr></thead>
                        <tbody>
                            <?php 
                           
							$queryLeads="SELECT * FROM leads WHERE brand LIKE 'TIM CONSUMER' order by data_inserimento DESC"; 
                            ...
                            <tr id="id_<?php echo $id;?>">                       
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="#" role="button" class="btn btn-sm btn-warning" onclick="open_leads_tim_consumer(<?php echo $id;?>)"><i class="fa fa-pencil" title="Modifica"></i></a>
                         ...
                         <tfoot><tr><th>Data Ins</th><th>Nome</th><th>Email</th><th>Telefono</th><th>Provenienza</th><th>Operatore</th><th>Esito OP</th><th>Esito BO</th><th>Note</th><th></th></tr></tfoot>
...
$(document).ready(function() {
    ...
    function checkNewLeads() {
        $.ajax({
            url: 'check_new_leads_tim_consumer.php', // URL del file PHP per controllare le nuove lead
            type: 'GET',
            dataType: 'json',
    ...
    setInterval(checkNewLeads, 600000); // Cambia 10000 con il tempo desiderato in millisecondi
